...
/// Token do iOS que permite ao Atlas iniciar uma Live Activity via APNs antes
/// de o app ser aberto. É rotativo, pertence à instalação e nunca é reutilizado
/// como token de uma activity já criada.
