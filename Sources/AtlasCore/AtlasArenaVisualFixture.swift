...
public enum AtlasArenaVisualFixture {
    ...
    static let capabilities = #"""
    {
      ...
      "capabilities":[
        ...
        {"capability":"long_horizon","label_pt":"Trabalho de longo prazo","score":0.39,"with_atlas":0.42,"baseline_ci":[0.25,0.55],"with_atlas_ci":[0.27,0.58],"baseline_cases":36,"with_atlas_cases":36,"delta":{"value":0.03,"ci_low":-0.20,"ci_high":0.26,"significant":false},"confidence":"measured","measurement_type":"continuous","suites_contributing":["hal_harness","swe_marathon"],"cases_total":36,"min_cases_for_confidence":10},
