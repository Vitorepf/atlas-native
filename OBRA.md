...
- [ABERTO · Tema · 2026-07-27 · Fable→Codex] **Paleta duplicada entre app e Widgets — extrair para arquivo compartilhado** — `Ink` (`App/Widgets/AtlasWidgetsHostB.swift`) é cópia MANUAL de `AtlasTheme`: 7 cores, 5 idênticas e **2 que já tinham divergido** (`alert` #E0755F vs #E08C8C; `healed` #7FB68F vs #83B46D). O operador via dois vermelhos para o mesmo significado, app e widget na mesma tela. Alinhei os hex, mas a raiz continua: o target Widgets não compila `RootChrome.swift`, onde o tema vive. Conserto real = extrair a paleta para `Atlas/AtlasPalette.swift` e listá-lo em **ambos** os targets no `project.yml` — que é território do Codex (§1), daí o pedido. Enquanto não vier, a próxima divergência é questão de tempo.

- [FEITO · Tempo · 2026-07-27 · Fable] **Plural quebrado no `AtlasCodeAge` do Core** — devolvia `"1mês"`/`"2mês"` no picker de workspace e no radar. Corrigido para `"1 mês"`/`"2 meses"`. **Cruzei a fronteira §1 (`Sources/` é do Codex) com autorização explícita do operador ("tem permissão de tudo", 27/07)**; mudança de 2 linhas, sem contrato tocado, `AtlasCoreChecks` verde. **Correção ao pedido original:** eu havia registrado que os dois formatadores eram duplicata e que um deveria morrer. Estava errado — `AtlasCodeAge` responde *quando* ("agora", "ontem") e `AtlasCodeRelativeTime` responde *há quanto tempo*, sempre composto como `"há \(x)"`. Fundir produziria "há agora"/"há ontem". Os dois ficam, e cada um agora explica no código por que o outro existe.

- [ABERTO · Casca · 2026-07-27 · Fable→Codex] **`ConversationModel.cycleEffort()` parece morto** — varredura de código não encontrou nenhum chamador em `App/Atlas`, `UITests` ou `Widgets`; só a declaração (`ConversationModel.swift:220`). `setEffort(_:)`, que ele envolve, é usado normalmente. A casca não edita a lógica do model, então fica o pedido: confirmar se algum caminho do Core/engine chama, e deletar se não. Contexto: varredura de 27/07 achou 0 constantes `product*`/`spoken*` órfãs em 402 — este é o único resto suspeito.
...
- 2026-07-27 · Fable 5 · **fix(ui) — ressalva de confiança não pode ser a primeira a truncar** · `179fcec4` · Capacidades cortava "baixa c…" / "não…" em `lineLimit(1)`, deixando o delta legível e o aviso que o desqualifica cortado. Junto: `scripts/device-when-unlocked.sh`, que espera a janela de desbloqueio e instala sozinho — foi ele que fechou a prova de device. **Prova:** checks+build exit 0; tour verde; **PROVADO NO DEVICE**.
- 2026-07-27 · Fable 5 · **refactor(ui) — régua visual FECHADA: fonte 47→27, padding 34→20 (todos pares)** · `8827ffc4` · +`f6a39737` +`6af074be`. Regra legível no CODEMAP: *ímpar é bug*. **Prova:** checks+build exit 0; tour 10/10 contra o atlas-backend real; 35 telas em `docs/evidence/2026-07-26-tour-design-fable/depois`. **PROVADO NO DEVICE** 27/07 12:06 — `✓ Atlas rodando no iPhone` via `scripts/device-when-unlocked.sh`.
...
- 2026-07-27 · Fable 5 · **refactor(ui) — régua visual: 47→28 tamanhos de fonte, 34→28 paddings** · `6af074be` · App/Atlas + CODEMAP + OBRA §3. Fecha a contradição fusão-vs-split da §3 (coesão, não contagem). Migração só de saltos ≤1pt. **Prova:** checks+build exit 0; tour 10/10, 35 telas conferidas. **PROVADO NO DEVICE** (mesma instalação de 27/07 12:06).
...
- 2026-07-27 · Fable 5 · **fix(ui) — cor da conversa mentia; CTA de falha sob a pílula** · `b39d17e3` · trilho vinha de hash do nome sorteando entre ouro/verde/bronze (vocabulário de estado e domínio); `centered` da home sem rolagem escondia o "Tentar de novo". Dynamic Type: título de 4 → 43 caracteres em accessibility-extra-large.
- 2026-07-27 · Fable 5 · **fix(ui) — gráfico do Motor mentia sobre as medições** · `f465d5e3` · ArenaPremiumRoot. Eixo X categórico colapsava rodadas no mesmo ponto (segmentos verticais falsos); `catmullRom` inventava picos; legenda sem a série do composto e com duas cores iguais. **Prova:** checks+build exit 0; `testDesignTourArenaTabs` verde. **PROVADO NO DEVICE** (mesma instalação de 27/07 12:06).
- 2026-07-27 · Fable 5 · **polish(ui) — tela Código, hub Autônomos e +10 telas no tour** · `698e4084` · App/Atlas 10 + UITests. Nav bar translúcida vazando alerta; indicador de scroll inconsistente; "Create" (endpoint) no produto; par "sem Atlas"/"com Atlas" não reusado; retry com duas palavras. **Prova:** checks 613 verdes; `AtlasDesignTourTests` 10/10, 35 screenshots/rodada. **PROVADO NO DEVICE** (mesma instalação de 27/07 12:06).
- 2026-07-26 · Fable 5 · **polish(ui) — honestidade visual das superfícies (13 quebras do tour)** · `2e249e06` · App/Atlas 14 + A11yID.swift extraído. **Prova:** AtlasCoreChecks exit 0; `make build` exit 0; `AtlasDesignTourTests` **8/8 verde, 26 screenshots/rodada no simulador** (ver seção 26/07 abaixo). **PROVADO NO DEVICE** (instalação de 27/07 12:06).
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — natural-case workspace/Arena kickers (ciclo 329)** · `3ffe2bc9` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos natural-case kickers (ciclo 328)** · `fdfa9776` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos hub nav lines serif (ciclo 327)** · `89138ed4` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — rhythm sheet natural-case kicker (ciclo 326)** · `ea239bbf` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — profile avatar 48pt (ciclo 325)** · `db7722a6` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **fix(ui) — sectionLabel ViewBuilder warning (ciclo 324)** · `54060761` · App/Atlas 36. **Prova:** checks+build exit 0.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — workspace area filter chips (ciclo 319)** · `e4f1a0b0` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Home masthead brand mark (ciclo 318)** · `41abb455` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos unit row height (ciclo 317)** · `153ed9e3` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Code repo switcher serif (ciclo 316)** · `33b4e55c` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Code ask-pill clear 48pt (ciclo 315)** · `0f140d1a` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — search field 48pt (ciclo 314)** · `d968a662` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Code graph filter chips (ciclo 313)** · `863f6c8c` · App/Atlas 36. **Prova:** checks+build exit 0.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — processing send updatesFrequently (ciclo 308)** · `5f87c91c` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — residual system fonts cleared (ciclo 307)** · `33545be9` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos reason sheet craft (ciclo 306)** · `cb0de799` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — review accept/reject 48pt (ciclo 305)** · `47a1cef8` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — composer send 48pt (ciclo 304)** · `334c78ac` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — CircleButton 48pt glass (ciclo 303)** · `40a8c5d7` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — AgenticPill invite breath (ciclo 302)** · `f0c16dd8` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena primary serif CTA (ciclo 301)** · `0bb2318f` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos primary CTA breath (ciclo 300)** · `cdcbcc62` · App/Atlas 36. **Prova:** checks+build exit 0.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — Home rows Dynamic Type (ciclo 291)** · `4b2b2220` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos controlError VO priority (ciclo 290)** · `fff61e90` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse ConversationTypes + A11yID (ciclo 289)** · `48dd2ce6` · App/Atlas 36. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse SnapshotWriter (ciclo 288)** · `74a87a63` · App/Atlas 38. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse workspace/motion/type (ciclo 287)** · `878aaa1e` · App/Atlas 39. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fold into primary hosts (ciclo 286)** · `cb7a599e` · App/Atlas 42. **Prova:** checks+build exit 0.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse radar/camera/arena/findings (ciclo 281)** · `cca537cc` · App/Atlas 131. **Prova:** checks+build exit 0.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse continuity/rhythm/glyph/conventional (ciclo 276)** · `80397c8f` · App/Atlas 160. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse swipe/destination/FeedbackKind (ciclo 275)** · `f65533b4` · App/Atlas 164. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — collapse AutonomosModel peels (ciclo 274)** · `be251c75` · App/Atlas 168. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse glass + atlasUserMessage (ciclo 273)** · `c67b33db` · App/Atlas 171. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse ArenaFormat + attachments a11y (ciclo 272)** · `a6e125e8` · App/Atlas 173. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse cache/ficha/close (ciclo 271)** · `67b8bd52` · App/Atlas 175. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse Arena sparkline/failure/ops (ciclo 270)** · `a7e763ef` · App/Atlas 178. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse patch a11y + AtlasArea.of (ciclo 269)** · `96c0f647` · App/Atlas 181. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse PressableScale/Unit/Route (ciclo 268)** · `1bd43a04` · App/Atlas 183. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse LoadPhase + nonEmpty (ciclo 267)** · `1b002fb7` · App/Atlas 186. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse ConversationTypes peels (ciclo 266)** · `925281d0` · App/Atlas 188. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos failure empty craft (ciclo 265)** · `634dd8a9` · App/Atlas 196. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — compress Code load failure (ciclo 264)** · `fdef389d` · App/Atlas 196. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse Code palette helpers (ciclo 263)** · `b8a1b652` · App/Atlas 196. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse LiveSessionSnapshot (ciclo 262)** · `15fbcb56` · App/Atlas 198. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — heroSub + ArtifactPreviewState (ciclo 261)** · `4bd0dc19` · App/Atlas 199. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — empty peels + dead HomeSummary (ciclo 260)** · `c9cde85e` · App/Atlas 200. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse ChangeReview/Arena singleton peels (ciclo 259)** · `427b54cf` · App/Atlas 204. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse outline sheet peel (ciclo 258)** · `0bf64123` · App/Atlas 208. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — fuse vestment + drop ExecutionBanner a11y (ciclo 257)** · `1b5b1a1a` · App/Atlas 209. **Prova:** checks+build exit 0.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos hub+evolution only (ciclo 256)** · `75deb781` · App/Atlas 211. **Prova:** checks+build exit 0.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — code ask soft + clear 44 (ciclo 142)** · `d16760c1` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena disclosure/action hints (ciclo 141)** · `0ec8efe3` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos deferred a11y + glyph hint (ciclo 140)** · `c0d626f4` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — code repo picker a11y (ciclo 139)** · `b84f2c5e` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — edit-resend single haptic + rhythm 48 (ciclo 138)** · `5cdaf41c` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — sheet single haptic + Novo headers + tab 48 (ciclo 137)** · `2c45a5fd` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena reason 88 + search 44 (ciclo 136)** · `43cd11d7` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — primary CTA 48 + veto fields (ciclo 135)** · `d6b7686d` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Pausar medium + suite/profile headers (ciclo 134)** · `a650eda0` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Parar medium + edit-resend 44 (ciclo 133)** · `96290186` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — review file medium + Continuity ready header (ciclo 132)** · `61479760` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — audit toggle + draft fail + steer 44 (ciclo 131)** · `33390d7e` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — filter chips 44 + governed medium (ciclo 130)** · `06b56ce2` · App/Atlas 214. **Prova:** checks+build.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — heal/veto medium haptic (ciclo 125)** · `07d09b63` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Criar medium haptic (ciclo 124)** · `61d92ded` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena action medium primary (ciclo 123)** · `b4de5697` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Retomar medium CTA (ciclo 122)** · `f42a82fa` · App/Atlas 214. **Prova:** checks+build.
...
- 2026-07-21 · Grok 4.5 · **polish(ui) — new-since marker header (ciclo 117)** · `5453e529` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — code chip row a11y (ciclo 116)** · `5e158916` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — steer scope picker craft (ciclo 115)** · `78d9da22` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — steer instruction field 88pt (ciclo 114)** · `f3887166` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — ArenaFieldChrome 48pt (ciclo 113)** · `16ddf931` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — provenance file rows 48pt (ciclo 112)** · `63fa93ef` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — promote medium + reason fields (ciclo 111)** · `64b2ddac` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos header de-dupe (ciclo 110)** · `8aad4c5f` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos map header traits (ciclo 109)** · `ec0b1170` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — why biography craft (ciclo 108)** · `75e1bc9c` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos load failure a11y (ciclo 107)** · `a4d4bff2` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — button-style editorial springs (ciclo 106)** · `450ef56e` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — nonisolated execution clock (ciclo 105)** · `2c6d2f75` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — outline empty + row 48pt (ciclo 104)** · `2786300c` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — chevron silent + nav ids (ciclo 103)** · `66249809` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — disabled action no-op + unit id (ciclo 102)** · `46188757` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Autônomos CTA Environment RM (ciclo 101)** · `a95c6ba5` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — PressableScale editorial + grafo long-press (ciclo 100)** · `f5beb570` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — RM Environment wave (ciclo 099)** · `960be345` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — plan preview a11y + home RM (ciclo 098)** · `1a1e0b22` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — suite metrics spoken (ciclo 097)** · `aece5267` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — success notify run+continuity (ciclo 096)** · `e873c140` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — success notify + zoom reset (ciclo 095)** · `ae5fc1d5` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — medium haptic governed commits (ciclo 094)** · `98b4bb36` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — run sheet + radar status (ciclo 093)** · `9774db85` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena headers + coverage spoken (ciclo 092)** · `d671f569` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — capability header + undo 48pt (ciclo 091)** · `c05e5008` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — home write pill 48pt (ciclo 090)** · `31152b16` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — plan empty + queued metrics + provenance ask (ciclo 089)** · `87807e1e` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — execution proof + Arena exec header (ciclo 088)** · `7b91f0ac` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Novo Autônomo + queued header (ciclo 087)** · `bb87ead3` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — radar empty + toast + progress ring (ciclo 086)** · `8c447339` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena live a11y + primary CTA + mute (ciclo 085)** · `e326c66c` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — attachments + commit tap + draft remove (ciclo 084)** · `3b53e52c` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — workspace picker + grafo switcher (ciclo 083)** · `bb885ff0` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — swipe-back retroactive + LiveNow haptic (ciclo 082)** · `5c275c15` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — review chip + home pill + code copy (ciclo 081)** · `516df315` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena toggles + plan expand + empty header (ciclo 080)** · `e83e90f5` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — SheetRow + rhythm unmute + artifacts (ciclo 079)** · `72ff9393` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Arena list rows + add chrome (ciclo 078)** · `ccdcf2fc` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — Code heal/picker + timeline chips (ciclo 077)** · `1da52f1b` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — execution choices + Arena empty a11y (ciclo 076)** · `d0e1e410` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — nav chrome 44pt + WorkspaceRow haptic (ciclo 075)** · `b71dec69` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — composer/search/workspace 44pt (ciclo 074)** · `dab85b43` · App/Atlas 214. **Prova:** checks+build.
- 2026-07-21 · Grok 4.5 · **polish(ui) — HIG 44pt residual (ciclo 073)** · `b6292c0e` · App/Atlas 214. **Prova:** checks+build.
