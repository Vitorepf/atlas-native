...
| E-B | **PARCIAL** | **Grok 4.5** | peels contínuos App+Core | E-A* | CICLO B compressão 1 | **Ledger HEAD:** zero >109; max 109 (4 empatados); zero em 110; top ideal ≤100 atingido nos 8×110. | peels + `wc -l`; build Mac-pending |
...
| E-D | **IN_PROGRESS** | **Grok 4.5** | delete dead from C | E-C | CICLO D | dups clock `AtlasTime.formatActiveDuration`; peels ~180+; meta ≥60% linhas de C ainda PARCIAL | `b27294b` + peels XX |
