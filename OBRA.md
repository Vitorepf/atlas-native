...
| E-B | **PARCIAL** | **Grok 4.5** | peels contínuos App+Core | E-A* | CICLO B compressão 1 | **Ledger HEAD:** zero >100; max 100 (3 empatados); patamar ≤100 atingido em App/Core/Widgets. | peels + `wc -l`; build Mac-pending |
