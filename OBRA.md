...
| E-B | **PARCIAL** | **Grok 4.5** | peels contínuos App+Core | E-A* | CICLO B compressão 1 | **Ledger HEAD:** zero >110; max 110 (8 empatados); top ideal ≤100 pendente próxima onda. | peels + `wc -l`; build Mac-pending |
