...
- 2026-07-17 · Grok 4.5 · **CICLO B — peel ArtifactSheet → ArtifactViewer** · este commit · `ArtifactSheet.swift` 316→184; extrai `ArtifactViewer.swift` (158) — kind/byte labels, ArtifactFileFicha, ArtifactPreviewContent, ZoomableArtifactImage (pinch/drag/double-tap/a11y zoom); zero Route; comportamento idêntico. §4 E-B atualizado. Prova: `wc -l` 316→184+158; Swift toolchain ausente neste cloud — re-rodar `make build` no Mac.
