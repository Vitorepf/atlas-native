...
// WAVE-012 fused ExecutionProof+Expanded.swift

// --- ExecutionProof+ActivityRowCopy.swift ---
...
// --- ExecutionProof+ActivityRows+RowCell.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ActivityRows.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+Expanded+Artifacts.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+Expanded+ArtifactsA11y.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+Expanded+ArtifactsChevron.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+Expanded+ArtifactsLabel.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+Expanded+ArtifactsLead.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+Expanded+Blocks.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+Expanded+DecisionRow.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+Expanded+Quality.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+Expanded+Reason.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+Replay+Activities.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+Replay+Summary.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ReplayActivitySpoken.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ReplayQuality.swift ---


// --- ExecutionProof+ReplayQualityFlags.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ReplayQualityLine.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ReplayQualitySpoken.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ScrubberChrome.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ScrubberControls+Slider.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ScrubberControls+Stepper.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ScrubberControls.swift ---
extension ExecutionProof {
    @ViewBuilder
...
// --- ExecutionProof+ScrubberHeader.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ScrubberMeta.swift ---
extension ExecutionProof {
...
// --- ExecutionProof+ScrubberTitle.swift ---
extension ExecutionProof {
