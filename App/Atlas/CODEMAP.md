...
| **Grafo chrome (status/filtros/worktrees/semana)** | `AtlasCodeGraphChrome` status · `FilterChrome` · `WorktreeChrome` · `WeekChrome` |
...
| Plan card parts | `PlanCard` host · `PlanCardRevisionBody` · `PlanCardStepRow` |
