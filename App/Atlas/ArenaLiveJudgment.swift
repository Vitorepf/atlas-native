...
enum ArenaNowJudgment {
    ...
    static func productArenaPrefixed(_ title: String) -> String { "Arena · \(title)" }
    ...
    static let productPlan = "Plano"
    static let productCases = "Casos"
    static let productExecution = "Execução"
    static let productQueue = "Fila"
    static let productMotor = "Motor"
    static let productLive = "Ao vivo"
    static let productLastResult = "Último resultado"
    static let productMeasureOrder = "Ordem de medição"
    static let productNewMeasurement = "Nova medição"
    static let productPublicationBlocked = "Publicação bloqueada"
    static let productIndexByRound = "Índice por rodada"
    static let productBySuite = "Por suíte"
    static let productMeasuredCapabilityScale = "Capacidade medida · escala 0–10"
    static let productContributingSuites = "Suítes que contribuíram"
    static let productProvenance = "Proveniência"
    static let productHistory = "Histórico"
    static func productRemaining(_ remaining: Int) -> String { "\(remaining) restantes" }
