...
final class AtlasNativeSnapshotWriter {
    ...
    private static func liveSessions(from sessions: [LiveSessionSnapshot]) -> [AtlasNativeSnapshot.LiveSession]? {
    ...
    private static func timing(from timing: AtlasExecutionPresence.Timing) -> AtlasNativeSnapshot.LiveSession.Timing {
        switch timing {
    ...
    private static func fleet(from model: AutonomosModel) -> AtlasNativeSnapshot.Fleet? {
