...
Ondas **L–LXIV** (pós-XLIX): peels CICLO C/D residuais contínuos — Arena sheets + PlanCard + FleetMetric NumericText/RM + empty honesty — sem checkpoint humano entre ondas.
