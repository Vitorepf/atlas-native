# WAVE-047 — home-ops-attention-judgment-instrument

**Status:** design · proposed  
**Wave:** `WAVE-047-home-ops-attention-judgment-instrument`  
**Owner:** casca only (Grok B / Implementer)  
**Date:** 2026-07-21  
**Created by:** designer (recovered as 047 after 045 number collision with B handoff)
**Note:** originally proposed as WAVE-045 home-ops; B shipped 045 continuity handoff first. (v5 · council ≥3 explore · proposed < 2)  
**Δ patamar:** **max**  
